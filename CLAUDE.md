...
- **Phase 1 (W-1~W-8) + Phase 2 (F-1~F-4) 코드 완료** — v1.0.3은 미배포로 건너뛰고 **v1.0.4 합본**. **남은 것: `package.bat` 빌드 → 실기 테스트(150% 배율, 듀얼모니터 창캡처 마우스 이벤트, 계획서 §8 매트릭스) → 릴리즈 v1.0.4. 커밋도 아직 안 함.**
